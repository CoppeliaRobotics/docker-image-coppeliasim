...
COPY ./download/CoppeliaSim_Edu_V4_9_0_rev0_Ubuntu22_04.tar.xz /opt/
RUN tar -xf /opt/CoppeliaSim_Edu_V4_9_0_rev0_Ubuntu22_04.tar.xz -C /opt && \
    rm /opt/CoppeliaSim_Edu_V4_9_0_rev0_Ubuntu22_04.tar.xz

ENV COPPELIASIM_ROOT_DIR=/opt/CoppeliaSim_Edu_V4_9_0_rev0_Ubuntu22_04
